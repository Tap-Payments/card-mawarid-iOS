#
#  Be sure to run `pod spec lint card-mawarid-iOS.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.source       = { :git => "https://github.com/Tap-Payments/card-mawarid-iOS.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "card-mawarid-iOS/card-mawarid-iOS/Core/**/*.{swift,h,m}"
